...
public class ConvScannerActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int scannerActivityLayoutId = getApplication().getResources().getIdentifier("scanner_activity", "layout",
        ...
        int viewPagerId = getApplication().getResources().getIdentifier("pager", "id",
                getApplication().getPackageName());
    ...
    private class ConvScannerPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public CameraPreviewFragment getCameraPreviewFragment() {
            return (CameraPreviewFragment) _cameraPreviewFragment;
        }

        public ManualInputFragment getManualInputFragment() {
            return (ManualInputFragment) _manualInputFragment;
        }
    }
