...
public class CameraPreviewFragment extends Fragment implements ConvZBarScannerView.ResultHandler {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state) {
		...
		int cameraPreviewFragmentId = getActivity().getApplication().getResources()
				.getIdentifier("fragment_camera_preview", "layout", getActivity().getApplication().getPackageName());
		ViewGroup rootView = (ViewGroup) inflater.inflate(cameraPreviewFragmentId, container, false);
		int cameraPreviewFrameLayoutId = getActivity().getApplication().getResources()
				.getIdentifier("camera_preview_frame_layout", "id", getActivity().getApplication().getPackageName());
		...
		// Get ids
		int idUp = getResources().getIdentifier("text_view_id_up", "id",
				getActivity().getApplication().getPackageName());
		int idDown = getResources().getIdentifier("text_view_id_down", "id",
				getActivity().getApplication().getPackageName());
		int idkbButton = getResources().getIdentifier("kbButton", "id",
				getActivity().getApplication().getPackageName());
		int idscanButton = getResources().getIdentifier("scanButton", "id",
				getActivity().getApplication().getPackageName());
