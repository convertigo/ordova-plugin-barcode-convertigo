...
public class ManualInputFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		int manualInputFragmentId = getActivity().getApplication().getResources().getIdentifier("fragment_manual_input",
				"layout", getActivity().getApplication().getPackageName());
		ViewGroup rootView = (ViewGroup) inflater.inflate(manualInputFragmentId, container, false);

		int manualInputFieldId = getActivity().getApplication().getResources().getIdentifier("manualInputField", "id",
